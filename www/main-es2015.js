...
const routes = [
    ...
    {
        path: 'produtor',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-produtor-produtor-module */ "pages-produtor-produtor-module").then(__webpack_require__.bind(null, /*! ./pages/produtor/produtor.module */ "./src/app/pages/produtor/produtor.module.ts")).then(m => m.ProdutorPageModule)
    },
    {
        path: 'fazenda',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-fazenda-fazenda-module */ "pages-fazenda-fazenda-module").then(__webpack_require__.bind(null, /*! ./pages/fazenda/fazenda.module */ "./src/app/pages/fazenda/fazenda.module.ts")).then(m => m.FazendaPageModule)
    },
    {
        path: 'categoria',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-categoria-categoria-module */ "pages-categoria-categoria-module").then(__webpack_require__.bind(null, /*! ./pages/categoria/categoria.module */ "./src/app/pages/categoria/categoria.module.ts")).then(m => m.CategoriaPageModule)
    },
    {
        path: 'raca',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-raca-raca-module */ "pages-raca-raca-module").then(__webpack_require__.bind(null, /*! ./pages/raca/raca.module */ "./src/app/pages/raca/raca.module.ts")).then(m => m.RacaPageModule)
    },
    {
        path: 'aparte',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-aparte-aparte-module */ "pages-aparte-aparte-module").then(__webpack_require__.bind(null, /*! ./pages/aparte/aparte.module */ "./src/app/pages/aparte/aparte.module.ts")).then(m => m.ApartePageModule)
    },
    {
        path: 'tipomanejo',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-tipomanejo-tipomanejo-module */ "pages-tipomanejo-tipomanejo-module").then(__webpack_require__.bind(null, /*! ./pages/tipomanejo/tipomanejo.module */ "./src/app/pages/tipomanejo/tipomanejo.module.ts")).then(m => m.TipomanejoPageModule)
    },
    {
        path: 'animal',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-animal-animal-module */ "pages-animal-animal-module").then(__webpack_require__.bind(null, /*! ./pages/animal/animal.module */ "./src/app/pages/animal/animal.module.ts")).then(m => m.AnimalPageModule)
    },
    {
        path: 'manejo',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-manejo-manejo-module */ "pages-manejo-manejo-module").then(__webpack_require__.bind(null, /*! ./pages/manejo/manejo.module */ "./src/app/pages/manejo/manejo.module.ts")).then(m => m.ManejoPageModule)
    },
