...
var ManejoPageModule = /** @class */ (function () {
    function ManejoPageModule() {
    }
...
var ManejoPage = /** @class */ (function () {
    function ManejoPage(sqlite) {
        this.sqlite = sqlite;
        this.id = 0;
        this.identanimal = "";
    ...
    ManejoPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(400);
    };
    ManejoPage.prototype.ionViewDidEnter = function () {
        this.scrollToTop();
    };
    ManejoPage.prototype.createDB = function () {
        var _this = this;
        this.sqlite.create({
    ...
    ManejoPage.prototype.createTable = function () {
        var _this = this;
    ...
    ManejoPage.prototype.save = function () {
        var _this = this;
    ...
    ManejoPage.prototype.getAll = function () {
        var _this = this;
    ...
    ManejoPage.prototype.getTipoManejos = function () {
        var _this = this;
    ...
    ManejoPage.prototype.compareFn = function (e1, e2) {
        return e1 && e2 ? e1.id === e2.id : e1 === e2;
    };
    ManejoPage.prototype.getProdutores = function () {
        var _this = this;
    ...
    ManejoPage.prototype.getFazendas = function (id_produtor) {
        var _this = this;
    ...
    ManejoPage.prototype.getCategorias = function () {
        var _this = this;
    ...
    ManejoPage.prototype.getRacas = function () {
        var _this = this;
    ...
    ManejoPage.prototype.getApartes = function (id_tipomanejo) {
        var _this = this;
        this.databaseObj.executeSql("SELECT * FROM aparte where id_tipomanejo=?", [this.id_tipomanejo])
            ...
            if (res.rows.length > 0) {
                for (var i = 0; i < res.rows.length; i++) {
                    _this.apartes.push(res.rows.item(i));
                }
            }
            _this.id_aparte = _this.apartes.id;
        })
            .catch(function (e) {
            alert("error " + JSON.stringify(e));
        });
    ...
    ManejoPage.prototype.delete = function (item) {
        var _this = this;
    ...
    ManejoPage.prototype.limparManejos = function () {
        var _this = this;
    ...
    ManejoPage.prototype.update = function (item) {
        this.id = item.id;
        this.data = item.data;
    ...
    ManejoPage.prototype.clearfields = function () {
        this.id = 0;
        this.data = null;
        this.id_tipomanejo = 0;
        this.identanimal = "";
    ...
    ManejoPage.prototype.importarManejo = function () {
        var _this = this;
        this.databaseObj.sqlBatch([
    ...
    ManejoPage.prototype.ngOnInit = function () {
        this.createDB();
    };
    ManejoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-manejo-manejo-module-es5.js.map